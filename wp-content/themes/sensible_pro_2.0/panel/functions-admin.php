...
// admin area styling
function sensible_custom_colors() {
...
add_action('admin_head', 'sensible_custom_colors');
...
add_action( 'tgmpa_register', 'sensible_recommend_plugin' );
function sensible_recommend_plugin() {
    ...
    $plugins = array(
		...
		array(
			'name' 		=> 'WooCommerce', // http://wordpress.org/plugins/woocommerce/
			'slug' 		=> 'woocommerce', 
			'required' 	=> false
		),      
    );
