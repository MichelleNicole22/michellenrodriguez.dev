...
/*-----------------------------------------------------------------------------------------------------//
	Sensible Widget Columns
-------------------------------------------------------------------------------------------------------*/
	
function sensible_widget_columns() {
	
	 $widget_columns = get_theme_mod( 'sensible_widget_columns' );
...
add_action( 'wp_enqueue_scripts', 'sensible_widget_columns' );
