...
// constructor
	...
	// Check values
		...
		$social_medium_link  = isset( $instance['social_medium_link'] ) ? esc_url( $instance['social_medium_link'] ) : '';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_medium_link')); ?>"><?php esc_html_e('Medium URL:', 'sensible'); ?></label>

	<input class="widefat" id="<?php echo sanitize_text_field( $this->get_field_id('social_medium_link')); ?>" name="<?php echo sanitize_text_field( $this->get_field_name('social_medium_link')); ?>" type="text" value="<?php echo esc_url( $social_medium_link ); ?>" /> 
	...
	function update($new_instance, $old_instance) { 
		...
		$instance['social_medium_link']  = 	esc_url_raw($new_instance['social_medium_link']);
...
?>
    	...
    	<ul class='social-media-icons'>
			...
			<?php endif; ?>
            <?php if ($social_medium_link !='') : ?>
            	<li>
                <a href="<?php echo esc_url( $social_medium_link ); ?>" <?php if( $social_url_path ) : ?>target="_blank"<?php endif; ?>>
